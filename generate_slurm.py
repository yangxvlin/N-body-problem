...
if __name__ == "__main__":
    ...
    generate_slurm("nlogn_sequential", [1], "{}-1", [10, 100, 500, 1000, 2000], minutes=15)
    generate_slurm("nlogn_openmpi", [i for i in range(2, 13)], "{}-1", [10, 100, 500, 1000, 2000], minutes=15)
